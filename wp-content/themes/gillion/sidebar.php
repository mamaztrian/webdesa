...
if( function_exists( 'gillion_is_realy_woocommerce_page' ) && gillion_is_realy_woocommerce_page() && !is_search() ) :
	$sidebar = 'woocommerce-widgets';
elseif( get_page_template_slug( gillion_page_id() ) == 'page-blog.php' && !is_home() || is_archive() || is_author() || is_category() || is_home() || is_single() || is_tag() && 'post' == get_post_type() ) :
