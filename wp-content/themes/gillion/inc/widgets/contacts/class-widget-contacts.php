...
if( !class_exists('Widget_Contacts') ) :
	class Widget_Contacts extends WP_Widget {
		...
		function __construct() {
			$widget_ops = array( 'description' => esc_html__( 'Contacts', 'gillion' ) );

			parent::__construct( false, esc_html__( 'Shufflehound Contacts', 'gillion' ), $widget_ops );
		}
		...
		function form( $instance ) {
			...
			$titles = array(
				'widget-title'  => esc_html__( 'Social Title:', 'gillion' ),
				'address'       => esc_html__( 'Adress:', 'gillion' ),
				'phone'         => esc_html__( 'Phone:', 'gillion' ),
				'email'         => esc_html__( 'E-mail:', 'gillion' ),
				'working_hours' => esc_html__( 'Working hours:', 'gillion' ),
			);
