...
class FW_Option_Type_NewIcon extends FW_Option_Type
{
	...
	protected function _enqueue_static($id, $option, $data)
	{
		...
		if (isset($sets[ $option['set'] ])) {
			...
			if (!isset($this->enqueued_font_styles[ $style_hash ])) {
				wp_enqueue_style(
					"gillion-option-type-{$this->get_type()}-font-{$option['set']}",
					$set['font-style-src'],
					array(),
					fw()->manifest->get_version()
				);
	...
	protected function _render($id, $option, $data)
	{
		...
		return fw_render_view( get_template_directory().'/inc/includes/option-types/new-icon/view.php', compact('id', 'option', 'data', 'set'));
	}
	...
	private function generate_unknown_set($icon)
	{
		return array(
			...
			'container-class' => '',
			'groups' => array(
				'unknown' => esc_html__('Unknown Set', 'gillion'),
			),
			'icons' => array(
	...
	private function get_default_sets()
	{
		...
		//     groups => array(
		//         array(
		//             'title' => esc_htm__('Web Application Icons', 'gillion')
		//             'icons' => array('fa fa-adjust', 'fa fa-anchor', ...),
		//         ),
		//         array(
		//             'title' => esc_html__'Transportation Icons', 'gillion'),
		//             'icons' => array(...),
		//         ),
		//     )
		//
		...
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups' => array(
					'web-application' => esc_html__('Web Application Icons', 'gillion'),
					'hand'            => esc_html__('Hand Icons', 'gillion'),
					'transportation'  => esc_html__('Transportation Icons', 'gillion'),
					'gender'          => esc_html__('Gender Icons', 'gillion'),
					'file-type'       => esc_html__('File Type Icons', 'gillion'),
					//'spinner'         => 'Spinner Icons',
					//'form-control'    => 'Form Control Icons',
					'payment'         => esc_html__('Payment Icons', 'gillion'),
					//'chart'           => 'Chart Icons',
					'currency'        => esc_html__('Currency Icons', 'gillion'),
					'text-editor'     => esc_html__('Text Editor Icons', 'gillion'),
					'directional'     => esc_html__('Directional Icons', 'gillion'),
					'video-player'    => esc_html__('Video Player Icons', 'gillion'),
					'brand'           => esc_html__('Brand Icons', 'gillion'),
					'medical'         => esc_html__('Medical Icons', 'gillion'),
				),
				'icons'  => array(
