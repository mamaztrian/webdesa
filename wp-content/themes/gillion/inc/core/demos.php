...
function shufflehound_unyson_demo_notice() { ?>
    ...
    if( class_exists( 'OCDI_Plugin' ) && version_compare( (float)$phpversion, '5.3.2', '>' ) ) : ?>
        ...
        <div class="shufflehound-notice shufflehound-notice-important">
        	...
        	<span><?php esc_html_e('Demo installation method deprecased', 'gillion') ?></span>
        	<p>
                ...
                <br />
                <i><?php esc_html_e('This method is deprecased due to compatibility/installation issues with various website hostings', 'gillion') ?></i>
            </p>
        </div>
    ...
    <div class="shufflehound-notice" style="margin-bottom: 30px;">
    	<i class="dashicons-before dashicons-warning"></i>
    	<span><?php esc_html_e( 'This method will replace all your current website content', 'gillion' ) ?></span>
    	<p><?php esc_html_e( 'Please create current website content backup before installing it', 'gillion' ) ?></p>
    </div>
    ...
    if( !defined( 'WPB_VC_VERSION' ) ) :
        return '
            <div class="shufflehound-notice shufflehound-notice-important" style="margin-top: 0; margin-bottom: 20px;">
                <i class="dashicons-before dashicons-warning"></i>
                <span>'.esc_html__('Install/activate WPbakery Page Builder before Demo Import', 'gillion').'</span>
                <p>
